...
export default function EditTextPage() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    if (!response.ok) {
      ...
      toast.error((data as { error?: string }).error || 'Erro ao atualizar texto');
      return;
    }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Editar texto</h1>
        <p className="text-sm text-muted-foreground">Atualize as informações do texto.</p>
      </div>
